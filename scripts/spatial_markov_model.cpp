...
NumericVector clusterlabelupdate(NumericMatrix Wtriplet, NumericMatrix Wbegfin,
                                 ...
                                 int J, int M, double psi, NumericVector alpha_vec, IntegerVector cluster, NumericVector nu2)
{
  ...
  for(int j = 0; j < nsites; j++)
  {
    ...
    for(int m = 1; m <= M; m++) {
      ...
      log_priorpottskernel = psi * numnbr + alpha_vec[m - 1];
...
NumericVector clusterlabelupdatesinglescore(NumericMatrix Wtriplet, NumericMatrix Wbegfin,
                                            ...
                                            int J, int M, double psi, NumericVector alpha_vec, IntegerVector cluster, double nu2)
{
